      ...
      <div class="container pt-5">
        <div class="row justify-content-center">
          ...
          <div class="col-lg-5 col-md-12">
            <h2>Login Pemilih</h2>
            <p class="fw-semibold">Silahkan Login sebelum melakukan Voting</p>
            <form class="pb-5">
              <div class="mb-3">
                <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Username atau Email" />
              </div>
              <div class="mb-3">
                <input type="password" class="form-control" id="exampleInputPassword1" placeholder="Password" />
              </div>
              <p class="fw-semibold text-body-secondary">Belum mempunyai akun?<a href="registrasi.html" class="text-decoration-none text-primary"> Daftar</a></p>
